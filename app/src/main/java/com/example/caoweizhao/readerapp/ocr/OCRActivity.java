 ...
 */
package com.example.caoweizhao.readerapp.ocr;
...
public class OCRActivity extends BaseActivity {
    ...
    private void initAccessTokenWithAkSk() {
        ...
        }, getApplicationContext(), "3ZqF8iemoECYT9QE0Y2rvxWY", "Bnxzlhy4GEBdL9M4madXEYUvL2WSqe5K");

    }

    private String parseResult(OCR_result result) {
        StringBuilder sb = new StringBuilder();
        List<OCR_result.WordsResultBean> words = result.getWordsResult();
        for (OCR_result.WordsResultBean word : words
                ) {
